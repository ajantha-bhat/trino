        ...
        extends BaseTestContainer
{
    ...
    public static final String DEFAULT_IMAGE = "quay.io/keycloak/keycloak:21.1.1";
    ...
    public static String getUrlWithHostName()
    {
        return "http://" + DEFAULT_HOST_NAME + ":" + PORT;
    }
            ...
            extends BaseTestContainer.Builder<KeycloakContainer.Builder, KeycloakContainer>
    {
        private Builder()
        {
            ...
            this.envVars = ImmutableMap.of(
                    ...
                    "KC_HOSTNAME_URL", getUrlWithHostName());
        }
